...
public class BookDoktorActivity_b extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHelper = new DatabaseHelper(BookDoktorActivity_b.this);
        db = dbHelper.getReadableDatabase();

        final String[] dktr = {"Dr Ujengx"};
        ...
        btnBook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (sDktr != null && sJam != null && sTanggal != null ) {
                    {
                        AlertDialog dialog = new AlertDialog.Builder(BookDoktorActivity_b.this)
                                ...
                                .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        try {
                                            ...
                                            Toast.makeText(BookDoktorActivity_b.this, "Booking berhasil", Toast.LENGTH_LONG).show();
                                            finish();
                                        } catch (Exception e) {
                                            Toast.makeText(BookDoktorActivity_b.this, "Booking berhasil", Toast.LENGTH_LONG).show();
                                            finish();
                    ...
                    Toast.makeText(BookDoktorActivity_b.this, "Mohon lengkapi data pemesanan!", Toast.LENGTH_LONG).show();
                }
            }
        });
